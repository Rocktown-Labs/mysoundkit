...
const API_ORIGIN = "http://soundkit.test",
  ...
  publicReadCases = [
    ["/v1/artists", "array"],
    ["/v1/artists/discover", "object"],
    ["/v1/artists/luna-eclipse", "object"],
    ["/v1/artists/luna-eclipse/media", "object"],
    ["/v1/tracks", "array"],
  ...
  expectedOpenApiOperations = [
    ["get", "/v1/analytics/audience"],
    ["get", "/v1/analytics/earnings"],
    ["get", "/v1/analytics/live-impact"],
    ["get", "/v1/analytics/locations"],
    ["get", "/v1/analytics/overview"],
    ["get", "/v1/analytics/sources"],
    ["get", "/v1/analytics/timeseries"],
    ["get", "/v1/analytics/tracks"],
    ["get", "/v1/videos/{videoId}/analytics"],
    ["get", "/v1/artist-setup-guide"],
    ["get", "/v1/artists"],
    ["get", "/v1/artists/discover"],
    ["get", "/v1/artists/{username}"],
    ["get", "/v1/artists/{username}/media"],
    ["get", "/v1/battles"],
    ["delete", "/v1/battles/{battleId}"],
    ["post", "/v1/battles/challenge"],
    ["delete", "/v1/battles/challenges/{challengeId}"],
    ...
    ["get", "/v1/me/workspace"],
    ["post", "/v1/me/workspace/invitations"],
    ["delete", "/v1/me/workspace/invitations/{invitationId}"],
    ["delete", "/v1/me/workspace/members/{memberId}"],
    ["patch", "/v1/me/profile"],
    ...
    ["post", "/v1/tracks/{trackId}/finalize-upload"],
