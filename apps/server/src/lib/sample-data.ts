...
export const sampleProjects = [
  {
    ...
    isForSale: false,
    isPublic: true,
    listeningAccess: "public" as const,
    progress: 65,
...
export const sampleBattles = [
  {
    ...
    isFeatured: true,
    joinMode: "waiting_room" as const,
    participants: [
      {
        avatarUrl: "/soundkit-default-avatar.svg",
        id: "sample-artist-marco",
        name: "Marco",
        username: "marco",
      },
      {
        avatarUrl: "/soundkit-default-avatar.svg",
        id: "sample-artist-sable",
        name: "Sable",
        username: "sable",
      },
    ],
  ...
  },
  {
    ...
    isFeatured: true,
    joinMode: "watch_now" as const,
    participants: [
      {
        avatarUrl: "/soundkit-default-avatar.svg",
        id: "sample-artist-toni",
        name: "Toni",
        username: "toni",
      },
      {
        avatarUrl: "/soundkit-default-avatar.svg",
        id: "sample-artist-jae",
        name: "Jae",
        username: "jae",
      },
    ],
  ...
  },
  {
    ...
    participants: [
      {
        avatarUrl: "/soundkit-default-avatar.svg",
        id: "sample-artist-luna",
        name: "Luna Eclipse",
        username: "luna-eclipse",
      },
      {
        avatarUrl: "/soundkit-default-avatar.svg",
        id: "sample-artist-neon",
        name: "Neon Pulse",
        username: "neon-pulse",
      },
    ],
