  ...
  return (
    <div className={`grid gap-4 sm:grid-cols-2 xl:grid-cols-${columns}`}>
      {stats.map((stat, index) => (
        <Card
          key={index}
          className="bg-card/50 backdrop-blur-sm border-border/40 overflow-hidden relative group transition-all hover:border-primary/30"
        >
          ...
          <CardContent>
            <div className="text-2xl font-bold font-[family-name:var(--font-playfair)]">
              {stat.value}
            </div>
