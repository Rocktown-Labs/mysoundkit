...
export function MusicPlayer() {
  ...
  const [devices, setDevices] = useState<Device[]>([
    { id: "1", name: "This Computer", type: "computer", active: true },
    { id: "2", name: "iPhone", type: "phone", active: false },
    { id: "3", name: "Living Room Speaker", type: "speaker", active: false },
  ])
        ...
        <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:gap-4">
          ...
          <div className="flex flex-col gap-2 lg:w-1/2">
            <div className="flex items-center justify-center gap-2">
              ...
              <Button variant="ghost" size="icon" className="h-8 w-8" onClick={handleRepeatToggle}>
          ...
          <div className="flex items-center justify-end gap-2 lg:w-1/4">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="icon" className="h-8 w-8 hidden lg:flex">
                  {getDeviceIcon(devices.find((d) => d.active)?.type || "computer")}
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent align="end" className="w-56">
                <div className="px-2 py-1.5 text-sm font-semibold">Available Devices</div>
                {devices.map((device) => (
                  <DropdownMenuItem
                    key={device.id}
                  ...
                  >
                    ...
                    {device.active && <div className="h-2 w-2 rounded-full bg-primary" />}
                  </DropdownMenuItem>
                ))}
              </DropdownMenuContent>
            </DropdownMenu>
            ...
            <div className="hidden items-center gap-2 lg:flex">
              <Button variant="ghost" size="icon" className="h-8 w-8" onClick={handleVolumeToggle}>
