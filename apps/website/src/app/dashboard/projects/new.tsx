...
function NewProjectPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {/* Header */}
        <div>
          <h1 className="text-2xl font-bold font-[family-name:var(--font-playfair)]">Create New Project</h1>
          <p className="text-muted-foreground">Set up a new music collaboration project</p>
        </div>
