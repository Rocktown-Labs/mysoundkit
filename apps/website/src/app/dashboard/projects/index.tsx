...
const mockProjects = [
  ...
  },
  {
    ...
    status: "draft",
    collaborators: ["user@soundkit.app", "collab@soundkit.app", "artist@soundkit.app"],
    releaseDate: null,
  ...
  return (
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold font-[family-name:var(--font-playfair)]">Projects</h1>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <span className="text-xs text-muted-foreground">{project.trackCount} tracks</span>
                      </div>
                    </div>
                  </div>
                  <DropdownMenu>
          ...
          <Card className="bg-card/50 backdrop-blur-sm border-border/40">
            <CardContent className="flex flex-col items-center justify-center py-16">
              ...
              <p className="text-muted-foreground text-center mb-6 max-w-md">
                Create your first album or EP project to organize your tracks and collaborate with your team.
              </p>
              <Link to="/dashboard/projects/new">
                <Button className="bg-primary hover:bg-primary/90">
                  <Plus className="h-4 w-4 mr-2" />
