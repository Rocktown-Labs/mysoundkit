  ...
  return (
      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold font-[family-name:var(--font-playfair)]">Collaborators</h1>
        ...
        <Card className="bg-card/50 backdrop-blur-sm border-border/40">
          <CardHeader>
            <CardTitle className="font-[family-name:var(--font-playfair)]">Invite Collaborator</CardTitle>
            <CardDescription>Send an invitation to collaborate on your music projects</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex gap-2">
              <Input placeholder="Enter email address" className="bg-input/50 border-border/60" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {mockCollaborators.map((collaborator) => (
            <Card key={collaborator.id} className="bg-card/50 backdrop-blur-sm border-border/40">
