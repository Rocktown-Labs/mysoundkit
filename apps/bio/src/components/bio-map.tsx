...
const usGeoUrl = new URL("../assets/maps/us-states-10m.json", import.meta.url)
    .href,
  worldGeoUrl = new URL(
...
function MapFallback() {
  return (
    <div className="relative h-[320px] w-full sm:h-[420px] md:h-[480px] overflow-hidden rounded-3xl border border-border/50 bg-card/40 backdrop-blur-xl flex items-center justify-center">
